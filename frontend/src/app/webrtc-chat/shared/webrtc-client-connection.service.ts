  ...
  public connectToRoom() {
    this.mediaStream
      ...
      .then((stream: MediaStream) => {
        ...
        this.me = new WebRTCClient({ id : this.socket.id, stream: this.myMediaStream});
        this.webrtcClientStore.addClient(this.me);
      })
      .catch(err => console.error('Can\'t get media stream', err));
  }

  public disconnect() {
    this.webrtcClientStore.removeClient(this.me);
  }
